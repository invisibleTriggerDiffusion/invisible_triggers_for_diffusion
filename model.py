...
from diffusers import UNet2DModel, DDPMScheduler, DDPMPipeline, DDIMScheduler, DDIMPipeline, DPMSolverMultistepScheduler
...
class DiffuserModelSched():
    ...
    def __get_model_sched(ckpt_id: str, clip_sample: bool):
        ...
        # Pipeline
        pipline: DDPMPipeline = DDPMPipeline.from_pretrained(ckpt_id, cache_dir='./premodels')
    ...
    def get_model_sched(image_size: int, channels: int, model_type: str=MODEL_DEFAULT, clip_sample: bool=None, **kwargs):
        ...
        if model_type == DiffuserModelSched.MODEL_DEFAULT:
            ...
            model, noise_sched = DiffuserModelSched.get_pretrained(ckpt='res_DDPM-CIFAR10-32_CIFAR10_ep1_c1.0_p0.0_STOP_SIGN_14-HAT', clip_sample=clip_sample) # DiffuserModelSched.DDPM_CIFAR10_32
